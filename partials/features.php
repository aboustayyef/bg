<div class="bgFeatures__outer">
	<div class="bgFeatures__inner layout__inner">
		<div class="bgFeaturesHeader">
		</div>
		<div class="bgFeature">
			<h3 class="bgFeature__h3"></h3>
			<p class="bgFeature__p"></p>
		</div>
		<div class="bgFeature">
			<h3 class="bgFeature__h3"></h3>
			<p class="bgFeature__p"></p>
...
<div class="container-fluid layout__inner">
	...
	<div class="col-md-4">
		<h3 class="bgFeature__h3">Tasteful</h3>
		<p>Beautiful furniture executed by award-winning designers and trend setters.</p>
	</div>
	<div class="col-md-4">
		<h3 class="bgFeature__h3">Long-lasting</h3>
		<p>High-quality products made by durable material certified by the highest level of quality control.</p>
	</div>
	<div class="col-md-4">
